/**
 * Cloudflare Pages Function: /api/img
 * 
 * Proxies TMDB images through your own domain (moovie.fun) so that
 * ISPs that have blocked image.tmdb.org cannot block your site's posters.
 * 
 * Usage: /api/img?path=/w500/abc.jpg
 * Caches images aggressively at the Cloudflare edge (7 days).
 */
export async function onRequest(context) {
  ...
  // Validate path — only allow safe TMDB image paths
  // Must start with /w or /original or /h or /b

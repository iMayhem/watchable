...
export default defineComponent({
    ...
    setup() {
        ...
        const buildDiscoverUrl = (pageNum: number): string => {
            ...
            return `https://tmdb-proxy.sujeetunbeatable.workers.dev/3/discover/movie?${params.toString()}`;
        };
        ...
        const buildSearchUrl = (pageNum: number): string => {
            ...
            return `https://tmdb-proxy.sujeetunbeatable.workers.dev/3/search/movie?${params.toString()}`;
        };
